...
<ul>
    <% foreach(var comment in Model) { %>
        <li class="Comment">
            ...
            <p><a href="#"><strong><%: comment.User.FullName() %></strong></a> commented on <strong><%: comment.Created.Date.ToShortDateString() %></strong> at <strong><%: comment.Created.TimeOfDay %></strong> saying:</p>
