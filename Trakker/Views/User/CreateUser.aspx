...
<% using (Html.BeginForm())
   { %>
    <h2>CreateUser</h2>
        ...
        <%= Html.FormRow()
           .AddToLeft(Html.LabelFor(x => x.View.RePassword).ToString())
           .AddToRight(Html.TextBox("RePassword", Model.View.RePassword).ToString()) %>

        <%= Html.FormRow()
           .AddToLeft(Html.LabelFor(x=>x.View.Roles).ToString())
           .AddToRight(Html.DropDownList("RoleId", new SelectList(Model.View.Roles, "RoleId", "Name", Model.View.RoleId )).ToString()) %>
