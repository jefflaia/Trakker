...
Sys._ScriptLoader = function Sys$_ScriptLoader() {
    ...
    function Sys$_ScriptLoader$notifyScriptLoaded() {
        ...
        this._currentticket._notified++;
        
        if(Sys.Browser.agent === Sys.Browser.Safari) {           
            if(this._currentticket._notified === 1) {
                window.setTimeout(Function.createDelegate(this, function() {
                    this._scriptLoadedHandler(this._currentticket.get_scriptElement(), true);
                }), 0);
            }
        }
    }
    ...
    function Sys$_ScriptLoader$_loadScriptsInternal() {
        ...
        if (session.scriptsToLoad && session.scriptsToLoad.length > 0) {
            ...
            if (typeof(nextScript.src) === "string") {
                this._currentticket = new Sys._ScriptLoaderticket(scriptElement, this._scriptLoadedDelegate);
                this._currentticket.execute();
            }
            else {
    ...
    function Sys$_ScriptLoader$_raiseError(multipleCallbacks) {
        ...
        var scriptElement = this._currentticket.get_scriptElement();
        this._stopSession();
    ...
    function Sys$_ScriptLoader$_scriptLoadedHandler(scriptElement, loaded) {
        if(loaded && this._currentticket._notified) {
            if(this._currentticket._notified > 1) {
                this._raiseError(true);
            }
            else {
                Array.add(Sys._ScriptLoader._getLoadedScripts(), scriptElement.src);
                this._currentticket.dispose();
...
Sys._ScriptLoaderticket = function Sys$_ScriptLoaderticket(scriptElement, completedCallback) {
    /// <summary locid="M:J#Sys._ScriptLoaderticket.#ctor" />
    ...
    function Sys$_ScriptLoaderticket$get_scriptElement() {
        /// <value domElement="true" locid="P:J#Sys._ScriptLoaderticket.scriptElement"></value>
        if (arguments.length !== 0) throw Error.parameterCount();
        return this._scriptElement;
    }
    function Sys$_ScriptLoaderticket$dispose() {
        if(this._disposed) {
            return;
        }
        this._disposed = true;
    ...
    function Sys$_ScriptLoaderticket$execute() {
        /// <summary locid="M:J#Sys._ScriptLoaderticket.execute" />
        if (arguments.length !== 0) throw Error.parameterCount();
    ...
    function Sys$_ScriptLoaderticket$_addScriptElementHandlers() {
    ...
    function Sys$_ScriptLoaderticket$_removeScriptElementHandlers() {
    ...
    function Sys$_ScriptLoaderticket$_scriptErrorHandler() {
        if(this._disposed) {
            return;
        }
    ...
    function Sys$_ScriptLoaderticket$_scriptLoadHandler() {
        if(this._disposed) {
            return;
        }
        var scriptElement = this.get_scriptElement();
...
Sys._ScriptLoaderticket.prototype = {
    get_scriptElement: Sys$_ScriptLoaderticket$get_scriptElement,
    dispose: Sys$_ScriptLoaderticket$dispose,
    execute: Sys$_ScriptLoaderticket$execute,
    _addScriptElementHandlers: Sys$_ScriptLoaderticket$_addScriptElementHandlers,    
    _removeScriptElementHandlers: Sys$_ScriptLoaderticket$_removeScriptElementHandlers,    
    _scriptErrorHandler: Sys$_ScriptLoaderticket$_scriptErrorHandler,
    _scriptLoadHandler: Sys$_ScriptLoaderticket$_scriptLoadHandler  
}
Sys._ScriptLoaderticket.registerClass("Sys._ScriptLoaderticket", null, Sys.IDisposable);
